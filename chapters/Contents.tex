...
%    %*******************************************************
	...
	\acro{DBM}[DBM]{drag-based model\acroextra{ \citep[for CME propagation][]{Vrsnak-2013}}}
	...
	\acro{ForbMod}[ForbMod]{Forbush decrease model for flux rope ICMEs\acroextra{ \citep{Dumbovic2018-ForbMod,Dumbovic-2020-ForbMod}}}
	\acro{FOV}[FOV]{field of view}
	\acro{GCR}[GCR]{galactic cosmic ray}
	\acro{GCS}[GCS]{graduated cylindrical shell\acroextra{ (model for CME reconstruction in coronagraphs, see \autoref{chp:GCS_Python})}}
