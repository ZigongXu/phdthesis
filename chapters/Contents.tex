...
%    %*******************************************************
	...
	\acro{ARS}[ARS]{Acute Radiation Syndrome}
	...
	\acro{CRI}[CRI]{Cutaneous Radiation Injuries}
	...
	\acro{IMP}[IMP]{Interplanetary Monitoring Platform}
	...
	\acro{STEREOLET}[LET]{Low-Energy Telescope}
	\acro{L1}[L1]{the first Lagrange point}
	\acro{LIS}[LIS]{Local Interstellar Spectra}
	\acro{VLISM}[VLISM]{Very Local Interstellar Medium}
   ...
   % \acro{SECCHI}[SECCHI]{Sun Earth Connection Coronal and Heliospheric Investigation\acroextra{ (remote sensing instrument suite onboard \acs{STEREO})}}
	...
	\acro{ACESIS}[SIS]{Solar Isotope Spectrometer\acroextra{ onboard \acs{ACE}}}
	...
	\acro{TPE}[TPE]{transport equation}
	\acro{UV}[UV]{ultraviolet}
	\acro{3DP}[3DP]{3D Plasma and Energetic Particle Investigation}
	\end{acronym}
