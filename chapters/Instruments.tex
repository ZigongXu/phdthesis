...
\missingfigure[options]{LND position in the Change'4 Lander

Explain change'4 mission.
Relay sattellite
including 4 internation     al payloads and 4 domestic payloads.
Environment, 
Up to now.

As one of the four internation payload, LND is designed by  Kiel and who.
Which is a instrument
Aim at 
The scientific object.
And technical experimental object

The current status of the LND, 
HET is a inherit instrument of HET, share the same designe logical.
Due to the limited design and limited budgetm, compare to the similar instrument`1'
Instrument bug, and the design of the LND is not perfect,
Beside, malfunction of the LND lid.
The change of the configuration and the change of the corresponding code (if you have time to track it)
Raise the threshold:code of L3
Disable A2: L2 whic branch 
...
a paragraph: explain clearly the reason of those two major malfunction;

Two major malfunctions of the LND}
