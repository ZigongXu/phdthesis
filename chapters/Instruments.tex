...
Due to the special operations of lander and the extra experiments from the ground, LND was completely switch off or switch on for a short period on the 6th, 44th, 45th lunar days. Up to May 2023, when the thesis finished, we have received the 46 lunar days data from January 2019 to the end of November 2022 which are stored in the server of Kiel group. The data is officially publishing in the \footnot[Lunar and Planetary Data release system]{\url{moon.bao.ac.cn}}, where you could find the data until December 2022. 
