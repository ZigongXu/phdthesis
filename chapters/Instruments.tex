This chapter describes the current status, the measurement principle and the latest updates of \ac{LND} onboard the lander of Chang`E - 4 mission and \ac{HET} onboard the \ac{SolO}. 
