...
Similar to \ac{RAD} on Mars (\autoref{sec:mslrad}), neutron monitor measurements are influenced by the Earth's atmosphere, as well as the magnetosphere, and thus any cosmic ray particle needs a certain minimum energy to be able to create a secondary neutron in the atmosphere that reaches the ground and can be detected in a neutron monitor. This cutoff energy is often also expressed in terms of a rigidity
\begin{equation}
	R = \frac{p}{q}
\end{equation}

% TODO: NMDB, atmospheric and magnetic cutoff, South pole neutron monitor, GSM.
