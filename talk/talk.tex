	...
	\begin{columns}
		\begin{column}{0.55\textwidth}
			\begin{itemize}
				...
				\item Approaches
				\begin{itemize}
					\item Analytical empirical models (DBM)
					\item MHD simulations (ENLIL, EUHFORIA)
		...
		\begin{column}{0.35\textwidth}
			\centering
			\animategraphics[poster=53,width=0.7\textwidth]{30}{plots/enlil_anim/enlil_anim}{00024}{00147}
			\footnotesize Guo et al. 2018
		\end{column}
	\end{columns}
\end{frame}
...
\begin{frame}{Deriving CME expansion from FD data (von Forstner et al. 2020)}
    \begin{columns}
		...
		\begin{column}{0.5\textwidth}
			\centering
			\scalebox{0.7}{\input{plots/fd_slope_correlation.pgf}}
		\end{column}
	\end{columns}
	\vskip-2mm
	\centering
