	...
	\begin{columns}
		\begin{column}{0.55\textwidth}
			\begin{itemize}
				...
				\begin{itemize}
					\item \textbf{Hit or miss?} \uncover<5->{\textcolor{red}{Hit rate $\approx\SI{50}{\percent}$, FAR $\approx\SI{10}{\percent}$}}
					\item \textbf{Arrival time?} \uncover<5->{\textcolor{red}{$\pm\sim\SI{10}{\hour}$}}
					\item \textbf{Geoeffectiveness?} -- $B_z$
				\end{itemize}
...
\begin{frame}{Radiation Assessment Detector (MSL/RAD)}
    ...
    \begin{tikzpicture}[remember picture,overlay]
        \node[xshift=-6.5cm,yshift=-3cm] at (current page.north east){%
            \includegraphics[width=2cm]{images/mslrad.jpg}};
    \end{tikzpicture}
\end{frame}
...
\begin{frame}{STEREO SECCHI}
    \begin{columns}
        \begin{column}{0.6\textwidth}
            \centering
            \scalebox{0.8}{\input{plots/secchi_fov.pgf}}\\[-1mm]
    ...
    \begin{columns}[T]
        \begin{column}{0.85\textwidth}
            ...
            \begin{vfilleditems}
            	...
            	\end{itemize}
            	\item<6-> HET provided observations of the first ICME observed at \textbf{Solar Orbiter} in April 2020, and the multi-spacecraft data can be used to validate FD models (von Forstner et al. 2021).
            \end{vfilleditems}
            }
        \end{column}
...
\begin{frame}{Outlook}
	...
	\end{vfilleditems}
    \begin{center}
        \uncover<2->{\summary Thank you for your attention!}
    \end{center}
    }
\end{frame}
