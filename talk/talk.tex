...
\begin{frame}{Time-elongation maps / J-maps}
    ...
    \begin{columns}
        ...
        \begin{column}{0.6\textwidth}
            ...
            \begin{overprint}
                \onslide<1>
                    \centerline{\includegraphics[width=0.58\textwidth]{images/HCME_A__20120123_01-runndiff.pdf}}%
                \onslide<2>
                    \centerline{\includegraphics[width=0.58\textwidth]{images/HCME_A__20120123_01-runndiff-slice.pdf}}%
                \onslide<3>
                    \centerline{\includegraphics[width=0.58\textwidth,angle=90,origin=c]{images/HCME_A__20120123_01-runndiff-slice.pdf}}%
                \onslide<4>
                    \centerline{\includegraphics[width=\textwidth]{images/HCME_A__20120123_01.pdf}}
            \end{overprint}
            {\raggedright\scriptsize Source: HELCATS project (\url{https://www.helcats-fp7.eu}, adapted)}
        \end{column}
    \end{columns}
    \centering
    \uncover<4>{\summary ICMEs can now be tracked as bright features. $\epsilon(t) \rightarrow r(t)$: geometric models.}
\end{frame}
