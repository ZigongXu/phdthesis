	...
	\begin{columns}
		\begin{column}{0.55\textwidth}
			\begin{itemize}
				...
				\begin{itemize}
					\item<alert@2> Analytical \textbf{empirical models} (DBM)
					\item<alert@3> \textbf{MHD} simulations (WSA-ENLIL+Cone, EUHFORIA)
...
\begin{frame}{Time-elongation maps / J-maps}
    ...
    \begin{columns}
        ...
        \begin{column}{0.6\textwidth}
            ...
            \only<5>{
                \animategraphics[autoplay,width=0.8\textwidth]{20}{plots/jmap_anim/HCME_B__20120116_01_diff_}{00164}{00222} 
            }\\
            {\raggedright\scriptsize Images: HELCATS project (\url{https://www.helcats-fp7.eu})}
        \end{column}
    \end{columns}
    \centering
...
\begin{frame}{Deriving CME expansion from FD data (von Forstner et al. 2020)}
    \begin{columns}
        ...
        \begin{column}{0.35\textwidth}            
            ...
            \[E = \frac{\textcolor{orange}{A_\text{Mars}}}{\textcolor{blue}{A_\text{Earth}}} \approx 1.9\]
