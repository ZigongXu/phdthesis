    ...
    \begin{columns}
        \begin{column}{0.5\textwidth}
            \begin{itemize}
                ...
                \item Structure: magnetic ejecta, shock, sheath
                \item Can cause disruptions to terrestrial infrastructure and spacecraft, shocks can                accelerate dangerous solar energetic particles (SEPs)\\
                $\rightarrow$ one of the main drivers of ``space weather''
            \end{itemize}
        \end{column}
        \begin{column}{0.4\textwidth}
        	\centering
            \includegraphics[width=\textwidth]{images/ZurbuchenRichardson-adapted.pdf}\\
            \footnotesize adapted from Zurbuchen and Richardson (2006)
        \end{column}
    \end{columns}
\end{frame}
    ...
    \begin{columns}
        \begin{column}{0.45\textwidth}
            \begin{itemize}
                ...
                \item cruise phase: 2011--2012 + surface phase since August 2012
                \item Data products: \textcolor{green}{charged} and \textcolor{gray}{neutral} particle spectra + Dosimetric measurements (TID, LET)
                \item TID in E has best statistics to observe FDs
            \end{itemize}
        \end{column}
        \begin{column}{0.45\textwidth}
