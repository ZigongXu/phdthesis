    ...
    \begin{columns}
        \begin{column}{0.54\textwidth}
            ...
            \begin{vfilleditems}
                ...
                \item One of the main drivers of \textbf{space weather} in the heliosphere
            \end{vfilleditems}
            }
        \end{column}
...
\begin{frame}[standout]          
    ...
    \begin{tikzpicture}[remember picture,overlay]
        \node[xshift=-5cm,yshift=2cm] at (current page.south east){%
...
\begin{frame}{Forbush decreases}
    \begin{columns}[T]
        \begin{column}{0.55\textwidth}
            ...
            \vfill
            \begin{vfilleditems}
                \item \textbf{Short-term decrases} of GCR intensity
                \item Discovered 1937 by Scott E. Forbush
                \item Turbulent or closed \textbf{magnetic structures} (ICMEs/SIRs) = barrier for GCRs
                \item Both ICME \textbf{shock/sheath} and \textbf{ejecta} modulate the GCRs
            \end{vfilleditems}
            \vfill
