		...
		\begin{column}{0.55\textwidth}
			\begin{itemize}
				...
				\begin{itemize}
					...
					\item<alert@3> Magnetohydrodynamic (\textbf{MHD}) simulations\\
    ...
    \begin{columns}[t]
        \begin{column}{0.55\textwidth}
            ...
            \begin{vfilleditems}
                ...
                \begin{itemize}
                    \item<alert@2> ICME \textbf{shock/sheath} and \textbf{ejecta} (flux rope)
                    \item<alert@3> Stream interaction regions (\textbf{SIRs})
                \end{itemize}
            \end{vfilleditems}
            \vfill
...
\begin{frame}{STEREO SECCHI}
    \begin{columns}
        \begin{column}{0.6\textwidth}
            \centering
            \vskip2mm
            \scalebox{0.85}{\animategraphics[poster=22]{10}{plots/secchi_fov_anim/secchi_fov_anim_}{0}{84}}\\[-1mm]
...
\begin{frame}{High Energy Telescope (HET)}
    \begin{columns}
        ...
        \begin{column}{0.55\textwidth}
            ...
            \footnotesize \textcolor{red}{stopping in B} \quad \textcolor{green}{stopping in C} \quad \textcolor{blue}{penetrating} \\ \uncover<2->{\textcolor{Aquamarine}{GCR channel}} \quad \uncover<3->{\textcolor{orange}{C single counter}}\\
            \uncover<4->{\input{plots/het_gcr.pgf}}
        \end{column}
    \end{columns}
\end{frame}
