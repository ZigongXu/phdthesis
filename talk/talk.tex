    ...
    \begin{columns}
        \begin{column}{0.54\textwidth}
            ...
            \begin{vfilleditems}
                ...
                \item Driven by magnetic reconnection at the Sun
                ...
                \item \textbf{Interaction} with solar wind, SIRs and other CMEs
                \item One of the main drivers of \textbf{space weather} effects
            \end{vfilleditems}
            }
        \end{column}
	...
	\begin{columns}
		\begin{column}{0.55\textwidth}
			\begin{itemize}
				...
				\begin{itemize}
					\item \textbf{Hit or miss?} \uncover<5->{\textcolor{red}{$\sim\SI{50}{\percent}$, \SI{10}{\percent} false alarm}}
...
\begin{frame}{Ideal constellations for multipoint (I)CME observations}
    \begin{columns}[t]
        \begin{column}{0.45\textwidth}
            \centering
            \textbf{Remote sensing:} \uncover<2->{from the side}\\
            \uncover<4->{or even from the poles?}\\[0.2cm]
            \begin{tikzpicture}
        ...
        \begin{column}{0.45\textwidth}
            \centering
            \textbf{In situ:} \uncover<5->{regular grid of observers}\\
            \strut\\[0.2cm]
            \begin{tikzpicture}
                \def\earthorbitradius{2.5}
                \def\sunradius{0.2}
    ...
    \begin{columns}[T]
        \begin{column}{0.55\textwidth}
            ...
            \begin{vfilleditems}
                ...
                \end{itemize}
                \item \textbf{Onset time} corresponds to ICME arrival
                \item FD amplitude is \textbf{energy-dependent}
            \end{vfilleditems}
            \vfill
