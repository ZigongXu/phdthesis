		...
		\begin{column}{0.55\textwidth}
			\begin{itemize}
				...
				\begin{itemize}
					...
					\item<alert@4> Machine Learning algorithms etc.
				\end{itemize}
			\end{itemize}
    ...
    \begin{columns}[T]
        \begin{column}{0.85\textwidth}
            ...
            \begin{vfilleditems}
            	...
            	\item \textbf{Forbush decreases} provide additional viewpoints for in situ observations and can also provide additional information about the ICME
            	\item For the first time, we studied ICMEs arriving at Mars statistically, finding:
            	\begin{itemize}
            		\item Fast ICMEs \textbf{continue to decelerate} beyond \SI{1}{\AU} (von Forstner et al. 2018)
            		\item \textbf{Heliospheric imager observations} can be used predict ICME arrivals at Mars, with similar performance as in previous studies (von Forstner et al. 2019)
            		\item \textbf{ICME expansion} between Earth and Mars can be derived from the FD profiles and is in line with measurements closer to the Sun (von Forstner et al. 2020)
            	\end{itemize}
        ...
        \begin{column}{0.1\textwidth}
            \centering
            \includegraphics[width=0.7\textwidth]{images/summary_pics/01_multispacecraft.PNG}\\[2mm]
...
\begin{frame}{Outlook}
	...
	\end{vfilleditems}
    {\centering\summary Thank you for your attention!}
    }
\end{frame}
