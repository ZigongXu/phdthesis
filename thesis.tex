...
\usepackage{enumitem}
\usepackage{doi}
\usepackage[style=authoryear-comp,natbib=true,backend=biber,uniquename=false,uniquelist=minyear,sortcites=false,maxcitenames=2,maxbibnames=99,date=year]{biblatex}
...
\cleardoublepage
\appendix
\include{chapters/Appendix_HETSimulation}

\cleardoublepage
\include{chapters/Appendix_GCSPython}
